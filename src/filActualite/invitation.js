...
export default function Invitation(){
    return(
     ...
     <div className="rounded-lg min-h-screen space-y-8 bg-green-500 ml-96 mt-14 mr-10 max-w-3xl flex flex-col">
         ...
         <div className="justify-center ml-8 mr-8 mt-8 bg-white rounded-full border-b-4 flex items-center px-2 py-3">
   ...
   <div className="mx-3">
     <h2 className="text-xl font-semibold text-gray-800"><a href="#" className="hover:text-green-700" >Mimouni feriel</a></h2>
